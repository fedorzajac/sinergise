...
import rasterio
import requests
from calculations import (acquisition_dates_to_download_dates, add_to_filename,
                          calculate_epsg, convert_polygon_to_utm,
                          fill_ndvi_gaps, generate_dekadal_dates,
                          interpolate_ndvi_to_dekadals, ndvi_raster_stats,
                          read_file, resize_raster_res, split_bbox)
...
for date in download_dates:
    ...
    for chunk in split_bbox(bbox):
        ...
        json_payload = payload(
            ...
            epsg=epsg,
            evalscript=read_file("./scripts/evalscripts/sentinel.js")
...
for date in dekadals:
    ...
    for chunk in split_bbox(bbox):
        ...
        json_payload = payload(
            ...
            bounding_box=[float(f) for f in chunk], # oh my types
            epsg=epsg,
            evalscript=read_file("./scripts/evalscripts/clms.js"),
